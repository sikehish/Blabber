  ...
  return (
    <div className=''>
      <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center">
        <header className="bg-gray-100 w-full py-4 border-b">
          <h1 className="text-white md: text-3xl lg:text-4xl px-5 text-left logo-bg">Blabber</h1>
        </header>
        <main className="flex flex-col items-center mt-8 px-4">
          <h1 className="text-9xl mb-4 superlarge logo-bg">Blabber</h1>
          <div className='container mx-auto sm:w-1/3 md:w-1/2 text-center'>
